...
def extract_grid_feature_argument_parser():
    ...
    parser.add_argument("--output_dir", default="", required=True, help="path to save the extracted feature")
    parser.add_argument("--weight_path", default="", required=True, help="path to the pretrained model weight")
    parser.add_argument(
        "opts",
